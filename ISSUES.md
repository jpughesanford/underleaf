...
- [] in the find and replace panel, make the all button the same color as the replace button. Change the replace and all hover styling to match that of the up and down arrow buttons. 
